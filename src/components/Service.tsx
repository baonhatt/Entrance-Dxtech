...
export const Service: React.FC = () => {
    return (
        <div className="services w-full px-24 pb-10">
           <SectionHeader title="Service"
            description="At our digital marketing agency, we offer a range of services to help"
           />
            <ServiceGrid />
            <div className="flex-1 h-[347px] p-16 bg-[var(--mygray)] rounded-[45px] max-sm:p-8">
...
export function IllustrationColumn() {
    return (
        <div className="ml-5 w-6/12 relative max-md:ml-0 max-md:w-full">
            <div className="ml-30 mt-[-5rem] absolute ">
    ...
    return (
        <div className="w-6/12  max-md:ml-0 max-md:w-full">
            <div className="max-w-[500px]">
                <h2 className="mb-7 text-3xl">Let's make things happen</h2>
                <p className="mb-7 text-lg">
                    Contact us today to learn more about how our digital marketing
                    services can help your business grow and succeed online.
                </p>
                <CustomButton width="w-[288px]" bgColor="bg-[var(--myblack)]" text="text-white" title="Get your free proposal" />
            </div>
        </div>
    );
}
